...
pf = pd.read_csv('dinns/Germany/4paper/remove_weight_from_residual_loss/84323763_0_117_0_53_real_data_estimated.csv')/N
...
print(len(total_epoch),len(total_data_loss_epoch),len(total_residual_loss_epoch))
